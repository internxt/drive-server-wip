...
import { GetFoldersInFoldersDto } from './get-folders-in-folder.dto';
import { SortOrder } from '../../../common/order.type';

describe('GetFoldersInFoldersDto', () => {
  ...
  it('When limit exceeds maximum (50), then it should fail', async () => {
    const dto = new GetFoldersInFoldersDto();
    dto.limit = 51;
    dto.offset = 0;
  ...
  it('When limit is at minimum valid value (1), then it should pass', async () => {
    const dto = new GetFoldersInFoldersDto();
    dto.limit = 1;
    dto.offset = 0;
  ...
  it('When offset is at minimum valid value (0), then it should pass', async () => {
    const dto = new GetFoldersInFoldersDto();
    dto.limit = 10;
    dto.offset = 0;
