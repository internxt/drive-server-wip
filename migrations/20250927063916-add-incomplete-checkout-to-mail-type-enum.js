...
const newMailType = 'incomplete_checkout';
  ...
  down: async (queryInterface) => {
    await queryInterface.sequelize.query(
      `
        ...
        CREATE TYPE mail_type AS ENUM('invite_friend', 'reset_password', 'remove_account', 'email_verification', 'deactivate_user', 'unblock_account', 'pre_create_user');
